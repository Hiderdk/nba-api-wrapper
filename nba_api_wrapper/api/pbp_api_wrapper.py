...
class PlayByPlayNbaApi(BaseApi):
    ...
    def __init__(self):
        ...
        self.client = Client(game_settings)
    ...
    def get_game_ids_by_date(self, date: pendulum.DateTime) -> list[Union[str, int]]:
        ...
        day_games = self.client.Day(date_str, "nba")
    ...
    def get_possessions_by_game_id(self, game_id: Union[str, int]) -> pd.DataFrame:
        ...
        for possession in game.possessions.items:
            ...
            possessions_data[PosessionModel.GAME_ID].append(game.game_id)
    ...
    def get_game_team_by_game_id(self, game_id: int) -> pd.DataFrame:
        ...
        for idx, team in enumerate(self._game_id_to_final_games[game_id].boxscore.data['team']):
